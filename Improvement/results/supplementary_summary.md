...
| Original SMC-QA | 13.6 | 0.100 | 0.800 | 0.650 | 0.000 |
...
- `single-session-assistant` I was going through our previous conversation about the impact of the political climate in Catalonia on its literature and music. Can you remind me of the example you gave of a Spanish-Catalan singer-songwriter who supports unity between Catalonia and Spain? (Original recall 0.00 -> Tuned recall 1.00)
- `multi-session` How many plants did I initially plant for tomatoes and cucumbers? (Original recall 0.50 -> Tuned recall 1.00)
- `temporal-reasoning` Which event did I participate in first, the charity gala or the charity bake sale? (Original recall 0.00 -> Tuned recall 0.50)

Top cases where retrieval-tuned SMC-QA regresses against original SMC-QA:

- `knowledge-update` Where do I currently keep my old sneakers? (Original recall 1.00 -> Tuned recall 0.50)
- `knowledge-update` How many times have I met up with Alex from Germany? (Original recall 0.50 -> Tuned recall 0.00)
- `multi-session` How much did I spend on car wash and parking ticket? (Original recall 1.00 -> Tuned recall 0.50)
